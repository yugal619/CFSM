...
class RequestsUtils:
    ...
    def post(host, path, **kwargs):
        ...
        :return: object: Response object
        """
        return RequestsUtils.process_request(host, path, method='POST', **kwargs)

    @staticmethod
    def put(host, path, **kwargs):
        """
        Sends an HTTP GET request and returns response
        ...
        :return: object: Response object
        """
        return RequestsUtils.process_request(host, path, method='PUT', **kwargs)

    @staticmethod
    def delete(host, path, **kwargs):
        """
        Sends an HTTP GET request and returns response
        ...
        :return: object: Response object
        """
        return RequestsUtils.process_request(host, path, method='DELETE', **kwargs)

    @staticmethod
    def patch(host, path, **kwargs):
        """
        Sends an HTTP GET request and returns response
        ...
        :return: object: Response object
        """
        return RequestsUtils.process_request(host, path, method='PATCH', **kwargs)
